...
: ${ONLINE_SSID:=Freifunk-Hennef}   # if for whatever reason ONLINE_SSID is NULL
OFFLINE_PREFIX='OFFLINE_' # use something short to leave space for the nodename (no '~' allowed!)
